...
library Monsters {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "x";
    _fieldNames[1] = "y";
    _fieldNames[2] = "spawned_at";
    _fieldNames[3] = "level";
    _fieldNames[4] = "monster_type";
  ...
  /** Get spawned_at */
  function getSpawned_at(bytes32 key) internal view returns (uint256 spawned_at) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  /** Get spawned_at (using the specified store) */
  function getSpawned_at(IStore _store, bytes32 key) internal view returns (uint256 spawned_at) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  /** Set spawned_at */
  function setSpawned_at(bytes32 key, uint256 spawned_at) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));

    StoreSwitch.setField(_tableId, _keyTuple, 2, abi.encodePacked((spawned_at)));
  }

  /** Set spawned_at (using the specified store) */
  function setSpawned_at(IStore _store, bytes32 key, uint256 spawned_at) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));

    _store.setField(_tableId, _keyTuple, 2, abi.encodePacked((spawned_at)));
  }
  ...
  function setMonster_type(bytes32 key, MonsterTypes monster_type) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 4, abi.encodePacked(uint8(monster_type)));
  }
  ...
  function setMonster_type(IStore _store, bytes32 key, MonsterTypes monster_type) internal {
    ...
    _store.setField(_tableId, _keyTuple, 4, abi.encodePacked(uint8(monster_type)));
  }

  /** Get the full data */
  function get(bytes32 key) internal view returns (MonstersData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  function get(IStore _store, bytes32 key) internal view returns (MonstersData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  function set(bytes32 key, MonstersData memory _table) internal {
    set(key, _table.x, _table.y, _table.spawned_at, _table.level, _table.monster_type);
  }

  /** Set the full data using the data struct (using the specified store) */
  function set(IStore _store, bytes32 key, MonstersData memory _table) internal {
    set(_store, key, _table.x, _table.y, _table.spawned_at, _table.level, _table.monster_type);
  }

  /** Decode the tightly packed blob using this table's schema */
  function decode(bytes memory _blob) internal pure returns (MonstersData memory _table) {
